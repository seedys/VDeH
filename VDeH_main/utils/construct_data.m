...
num_test = 1000;  % default setting: 1000 query test point, rest are database

% if strcmp(db_name, 'CIFAR10-Gist512')
%     num_test = 1000;                % for Gist512CIFAR10, 1000 query test point, rest are database
% elseif strcmp(db_name, 'LabelMe_gist')
%     num_test = 1000; 
% elseif strcmp(db_name, 'gist')
%     num_test = 1000; 
% elseif strcmp(db_name, 'kosarak')
%     num_test = 1000; 
% elseif strcmp(db_name, 'deep-image-96-angular')
%     num_test = 1000; 
% elseif strcmp(db_name, 'nytimes-256-angular')
%     num_test = 1000; 
% end
...
exp_data.knn_p2 = I(:,1:Nneighbors); 
exp_data.dis_p2 = Dball(:,1:Nneighbors); 
